...
namespace IsMatch.Rename
{
    class Program
    {
        ...
        /// 递归重命名文件
        /// </summary>
        /// <param name="srcDirectory">源路径</param>
        /// <param name="isCopyFolder">是否直接复制文件夹(具体配置在appsettings.json文件-CopyFolders)</param>
